...
import com.example.test.exception.custom.IllegalAdminAccess;
import com.example.test.util.iMenu;
...
import static com.example.test.com.main.LibrarySystem.*;

public class Admin extends com.example.test.data.User implements iMenu {
    ...
    private void displayBooks(Stage stage) {
        ...
        for (Book book : daftarBuku) {
            ...
            root.getChildren().add(new Label("Penulis: " + book.getAuthor()));
